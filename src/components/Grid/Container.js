...
const StyledContainer = styled.div`
   ...
   margin: ${props => (props.align == 'left') ? '0 auto 0 0' : (props.align == 'right' ? '0 0 0 auto' : '0 auto')};

   ${props => (typeof props.spaceAfter !== 'undefined') && css`margin-bottom: ${props.spaceAfter}px;`}
`;
